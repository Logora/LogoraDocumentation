...
<Tabs>
  <TabItem value="synthese" label="synthese" default>
    La valeur synthese permet d'afficher une question de débat lorsqu'un débat est lié à l'article. Si aucun débat n'est lié à l'article, vous pouvez décider d'afficher des commentaires à la place, en autorisant l'ajout dans commentaires dans la configuration de l'espace d'administration. 
  </TabItem>
