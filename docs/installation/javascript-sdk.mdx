...
<Tabs className={styles.uniqueTabs}>
    <TabItem value="Synthesis" label="Synthesis" default attributes={{className: styles.tabItem}}>
        <div>
            ...
            <figure> 
                <img src="/img/debatesynthesis.png" alt="synthesis" style="
    width: 400px;"  className={.width-400}/> 
            </figure>
            ...
            <figure> 
                <img src="https://github.com/Logora/LogoraDocumentation/assets/28570918/529423a0-eaf6-4736-8174-64c3c303b9b4" style="
    width: 400px;"/> 
            </figure>
            ...
            <figure> 
                <img src="/img/commentlight.png" alt="Light call to action for comments" /> 
            </figure>
            ...
            <figure> 
                <img src="/img/3comments.png" alt="Three comments displayed" /> 
            </figure>
            ...
            <figure> 
                <img src="/img/commentnotification.png" alt="Notification for comments" /> 
            </figure>
        </div>
    </TabItem>
