...
Le name indique par défaut la valeur "synthesis".
...
<Tabs className="unique-tabs">
    <TabItem value="Synthesis" label="Synthesis" default>
        <div>
            La valeur synthesis est la valeur par défaut qui est utilisé dans la très grande majorité des cas par nos partenaires. L'ID est l'identifiant de l'article. Synthesis permet d'afficher une question de débat lorsqu'un débat est lié à l'article comme ici :
            <figure> 
            ...
            <h4>Permettre l'ajout de commentaires lorsqu'aucun débat n'est lié à l'article (optionnel)</h4>
    ...
    <TabItem value="Arguments" label="Arguments">
        <CodeBlock language="javascript">
            {`
                resource: {
