...
If no discussion is linked to the article, you can decide to display comments instead, by authorising the addition of comments in the administration space configuration.
            <h4>Optional: Allow comments to be added when no debate is linked to the article
</h4>
...
<figure> 
    ...
    <TabItem value="Widget" label="Widget" attributes={{className: styles.tabItem}}>
        ...
        <p style={{ marginTop: "1em" }}>
        This code proposes the same thing as synthesis, but the debate question is displayed in a one-line format. The ID is the article identifier.        </p>
        <figure> 
